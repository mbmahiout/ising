...
int main() {
    ...
    EqModel ml_model {numUnits, J1, h1};
    ...
    EqModel pl_model {numUnits, J2, h2};
    ...
    */
    ...
    Timer t;
    Inverse::setMaxLikelihoodParams(ml_model, true_sim, maxSteps, lr, numSims, numBurn);  
    ...
    t.reset();
    Inverse::setMaxLikelihoodParams(pl_model, true_sim, maxSteps, lr);  
